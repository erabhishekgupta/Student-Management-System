...
<div style="justify-content:center ; margin: auto; text-align:center ; margin-top:2rem;"><h1 style="color:gray;
 text-decoration:underline">Edit the ID you want to Delete</h1></div>
<div class="row mt-3">
<div class="col-6 offset-3">
<form class="form-control" method="get" action="delete-record.jsp">
 <div class="mb-3">
...
<button type="submit" class="btn btn-secondary" style="margin-left:39rem ;margin-bottom:1rem ;color:white;
 background-color:black">Delete</button>
</form>
</div>
</div>
</body>
